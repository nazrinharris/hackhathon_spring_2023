// This follows this tutorial (it has the diagram and stuff):  https://learn.sunfounder.com/lesson-17-stopwatch-4-digit-7-segment-display-2/
...
int d3 = 11;
int d2 = 12;
int d1 = 13;long n = 1;// n represents the value displayed on the LED display. For example, when n=0, 0000 is displayed. The maximum value is 9999. 
int x = 100;
int del = 5;//Set del as 5; the value is the degree of fine tuning for the clock
int count = 0;//Set count=0. Here count is a count value that increases by 1 every 0.1 second, which means 1 second is counted when the value is 10void setup()
void setup() {
...
void add()
{
  ...
  {
    count = 0;
    if (n < 1000) { // Add this condition to stop at 1000
      n++;
    }
  }
}
